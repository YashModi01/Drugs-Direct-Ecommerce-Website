              ...
              <div class="col-md-12">
				...
				?>
                      ...
                      <tr>
                        ...
                        <td class="text-black">$<?php echo $total_cost; ?>.00</td>
                      </tr>
                      <tr>
                        ...
                        <td id="discount" class="text-black font-weight-bold"><strong>$<?php echo $total_cost - $_SESSION["coupon_cost"] ?>.00</strong></td>
						<?php
							}
							else{
						?>
						<td id="discount" class="text-black font-weight-bold"><strong>$<?php echo $total_cost ?>.00</strong></td>
						<?php
							}
						?>
                      </tr>
